...
export default function ArtigoList({ data }) {
  ...
  return (
    <>
    {data.map((data)=>(
      <div onClick={()=>{router.push(`/createDocs/${data._id}`)}} key={data?._id} id='artigolist'  className='w-full py-2 flex flex-row justify-between items-end text-#666 cursor-pointer hover:bg-[#F5F5F5]'>
