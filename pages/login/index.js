    ...
    <div className='container'>
      <div className="w-full h-full flex items-center gap-24">
        <div className="flex-1 flex flex-col items-center gap-5">
          ...
          <form className='flex flex-col items-center justify-center gap-5' onSubmit={hendleLogin}>
            <input className='p-5 border-none outline-none bg-[rgba(17, 25, 40, 0.6)] text-[#666] rounded-[5px]' type="enail" placeholder='Email' name='email' />
            <input className='p-5 border-none outline-none bg-[rgba(17, 25, 40, 0.6)] text-[#666]rounded-[5px]' type="password" placeholder='Senha' name='password' />
        ...
        <div className="flex-1 flex flex-col items-center gap-5">
          <h2>Criar conta.</h2>
            <form className='flex flex-col items-center justify-center gap-5' onSubmit={handleRegister}>
              ...
              <input  className='p-5 border-none outline-none bg-[rgba(17, 25, 40, 0.6)] text-[#666] rounded-[5px]' type="text" placeholder='Usuário' name='username' />
              <input  className='p-5 border-none outline-none bg-[rgba(17, 25, 40, 0.6)] text-[#666] rounded-[5px]' type="email" placeholder='Email' name='email' />
              <input  className='p-5 border-none outline-none bg-[rgba(17, 25, 40, 0.6)] text-[#666] rounded-[5px]' type="password" placeholder='Senha' name='password' />
              <button className='w-full p-5 border-none bg-[#1f8ef1] text-white rounded[5px] cursor-pointer font-semibold disabled:cursor-not-allowed bg-[#1f8ff18b] rounded-md' disabled={loading}>{ loading ? "Loading..." : "Criar Conta"}</button>
            </form>
        </div>
      </div>
    </div>
